...
class settings(commands.Cog):
    ...
    @commands.check_any(Checks.admin, commands.is_owner)
    def admin_add(self, ctx, role: discord.Role):
        await ctx.message.delete()
    ...
    @commands.check(Checks.admin)
    def admin_remove(self, ctx, role: discord.Role):
        await ctx.message.delete()
    ...
    @commands.check(Checks.admin)
    def mod_add(self, ctx, role: discord.Role):
        await ctx.message.delete()
    ...
    @commands.check(Checks.admin)
    def mod_remove(self, ctx, role: discord.Role):
        await ctx.message.delete()
    ...
    @commands.check(Checks.admin)
    def support_add(self, ctx, role: discord.Role):
        await ctx.message.delete()
    ...
    @commands.check(Checks.admin)
    def support_remove(self, ctx, role: discord.Role):
        await ctx.message.delete()
    ...
    @settings.command()
    @commands.check(Checks.admin)
    def breakrole(self, ctx, role: discord.Role):
        await ctx.message.delete()
